...
min_point = (min_point[0] - 228, min_point[1])
max_point = (max_point[0] + 228, max_point[1] + 2)
lines.append(((min_point[0], max_point[1]),(max_point[0], max_point[1])))
    ...
    for interval in zip(line[:-1], line[1:]):
        ...
        for i in range(from_index, to_index + 1):
            ...
            try:
                ...
                print(grid.min_point, grid.max_point)
                sys.exit()
